...
ARG IMAGE_COMPONENT="ironic-operator-container"
ARG IMAGE_NAME="ironic-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Ironic Operator"
ARG IMAGE_DESC="This image includes the ironic-operator"
