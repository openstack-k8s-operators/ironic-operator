...
test: manifests generate fmt vet envtest ginkgo ## Run tests.
	...
	$(GINKGO) --trace --cover --coverpkg=../../api/v1beta1,../../pkg/ironic,../../pkg/ironicapi,../../pkg/ironicconductor,../../pkg/ironicinspector,../../pkg/ironicneutronagent, --coverprofile cover.out --covermode=atomic --randomize-all ${PROC_CMD} $(GINKGO_ARGS) ./test/...
