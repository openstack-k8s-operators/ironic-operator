...
func (in *IronicConductorTemplate) DeepCopyInto(out *IronicConductorTemplate) {
	*out = *in
	...
	if in.TraitBasedNetworking != nil {
		in, out := &in.TraitBasedNetworking, &out.TraitBasedNetworking
		*out = new(TraitBasedNetworkingSpec)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraitBasedNetworkingAction) DeepCopyInto(out *TraitBasedNetworkingAction) {
	*out = *in
	if in.MinCount != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraitBasedNetworkingAction.
func (in *TraitBasedNetworkingAction) DeepCopy() *TraitBasedNetworkingAction {
	if in == nil {
		return nil
	}
	out := new(TraitBasedNetworkingAction)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraitBasedNetworkingEntry) DeepCopyInto(out *TraitBasedNetworkingEntry) {
	*out = *in
	if in.Actions != nil {
		in, out := &in.Actions, &out.Actions
		*out = make([]TraitBasedNetworkingAction, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraitBasedNetworkingEntry.
func (in *TraitBasedNetworkingEntry) DeepCopy() *TraitBasedNetworkingEntry {
	if in == nil {
		return nil
	}
	out := new(TraitBasedNetworkingEntry)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraitBasedNetworkingSpec) DeepCopyInto(out *TraitBasedNetworkingSpec) {
	*out = *in
	if in.Config != nil {
		in, out := &in.Config, &out.Config
		*out = make([]TraitBasedNetworkingEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraitBasedNetworkingSpec.
func (in *TraitBasedNetworkingSpec) DeepCopy() *TraitBasedNetworkingSpec {
	if in == nil {
		return nil
	}
	out := new(TraitBasedNetworkingSpec)
